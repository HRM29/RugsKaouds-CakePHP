$(document).ready(function () {
  "use strict";
  var o;
  (o = $(".owl-carousel-featured")).length > 0 &&
    o.owlCarousel({
      items: 4,
      lazyLoad: !0,
      pagination: !1,
    ...
    (o = $(".owl-carousel-category")).length > 0 &&
      o.owlCarousel({
        items: 8,
        lazyLoad: !0,
        pagination: !1,
  ...
  e.owlCarousel({
    ...
    afterAction: function (o) {
      ...
      $("#sync2")
        ...
        .eq(i)
        .addClass("synced"),
        void 0 !== $("#sync2").data("owlCarousel") &&
          (function (o) {
            var i = t.data("owlCarousel").owl.visibleItems,
              e = o,
              a = !1;
            for (var n in i) if (e === i[n]) var a = !0;
            !1 === a
              ? e > i[i.length - 1]
                ? t.trigger("owl.goTo", e - i.length + 2)
                : (e - 1 == -1 && (e = 0), t.trigger("owl.goTo", e))
              : e === i[i.length - 1]
              ? t.trigger("owl.goTo", i[1])
              : e === i[0] && t.trigger("owl.goTo", e - 1);
          })(i);
    },
