  ...
  function convert_multi_array($array) {
    ...
    */
    ...
    public function users(){
        ...
        'keyField' => 'id',
        'valueField' => 'first_name'])->where(['role_id' => 2 ,'status' => 1])->order(['id' => 'ASC']);
        $user = $query->all();
    ...
    */
	...
	public function countryList(){
        ...
        'keyField' => 'id',
        'valueField' => 'country_name'])->where(['status' => 1])->order(['country_name' => 'ASC']);
        $country = $query->all();
    ...
    */
	...
	public function statesList(){
        ...
        $query = $Table->find('list', [
        'keyField' => 'id',
        'valueField' => 'state'])->order(['state' => 'ASC']);
        $states = $query->all();
    ...
    */
	...
	public function statesByCon($c_id){
        ...
        $query = $Table->find('list', [
        'keyField' => 'id',
        'valueField' => 'region_name'])->where(['status' => 1,'country_id' => $c_id])->order(['region_name' => 'ASC']);
        $states = $query->all();
    ...
    */
	...
	public function getFilterPrice(){
		...
		$prizeArray = array("1-900"=>"Under $900",
                        "1000-2999"=>"$1000-$2999",
                        "3000-4999"=>"$3000-$4999",
                        "5000-6999"=>"$5000-$6999",
                        "7000-8999"=>"$7000-$8999",
