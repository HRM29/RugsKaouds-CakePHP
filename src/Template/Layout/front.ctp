...
<head>
	...
	<link href="<?php echo Router::url('/', true) . "favicon.ico"; ?>" type="image/x-icon" rel="icon" />
	<link href="<?php echo Router::url('/', true) . "favicon.ico"; ?>" type="image/x-icon" rel="shortcut icon" />
	<meta name="facebook-domain-verification" content="3rrn0glngylfceooaifricmhzex1j9" />
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<!-- <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"> -->
	<?php echo $this->Html->css(array('front/bootstrap.min.css?ver=1.0', 'front/bootstrap-icons.min.css?ver=1.0', 'front/owl.carousel.min', 'front/owl.theme.default.min', 'front/custom.css?ver=1.02e', 'front/responsive.css?ver=1.0', 'front/sweetalert2.min.css?ver=1.0', 'front/fancybox.umd.css?ver=0.1')); ?>
