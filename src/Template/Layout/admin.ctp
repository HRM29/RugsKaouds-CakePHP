...
<head>
	...
	<!-- Bootstrap 3.3.5 -->
	<?php echo $this->Html->css(array('../plugins/bootstrap/css/bootstrap.min', 'admin/AdminLTE.min', '../plugins/iCheck/css/all', '../plugins/iCheck/flat/css/blue', 'admin/skin-blue.min.css?ver=2.5A')) ?>
