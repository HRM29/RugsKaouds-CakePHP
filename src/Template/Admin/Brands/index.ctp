			...
			<div class="box box-primary">
				...
				<div class="box-body">
					...
					<div class="col-sm-3">
						...
						<a href="<?= Router::url('/', true).'/admin/brands/clearSearch';?>" class="btn btn-primary clear">Clear</a>
					</div> 
                  </div><!-- /.box-body --> 
		...
		<div class="col-xs-12"> 
		  <div class="box">
			<div class="box-header">
			  ...
			  <div class="box-tools">
					<?php 
					echo $this->Html->link('<i class="fa fa-plus"></i> Add Brand',
					array('controller' => 'brands','action'=>'add'),
					array('escape' => false,'class'=>"btn btn-success btn-sm","title"=>__("Add Brand",true))
					);
					?> 
					<?php 
			...
			<div class="box-body table-responsive no-padding">
				<?php echo $this->Form->create('',['url'=>['action'=>'deleteAllBrands'],'id'=>'listForm']); ?>
				<?php echo $this->Form->end()?>    
				...
				<tr>
					...
					<td><?php echo $this->Html->image('/uploads/brands/thumb/'.$val->image, array('alt' => $val->title, 'width' => '200px')); ?></td>
					<td><?= h($val->title) ?></td>
		...
		if(favorite.length < 1){
			...
			if(confirm('Are you sure you want to delete the selected pages?')){
				if(favorite.length > 0){
					...
					var url 	= '<?php echo Router::url('/', true).'admin/brands/deleteAllBrands';?>';
