		...
		<div class="col-xs-12">
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title">Search Drivers</h3>
                </div>
				<?php echo $this->Form->create($driver,array(
		...
		<div class="col-xs-12"> 
		  <div class="box">
			<div class="box-header">
			  ...
			  <div class="box-tools">
					<?php 
					echo $this->Html->link('<i class="fa fa-plus"></i> Add Driver',
					array('controller' => 'users','action'=>'add_driver'),
					array('escape' => false,'class'=>"btn btn-success btn-sm","title"=>__("Add Driver",true))
					);
					?>
			...
			<div class="box-body table-responsive no-padding">
			  ...
			  <table class="table table-hover"> 
				...
				<?php foreach ($driver as $key => $user): ?>
				<tr>
					<td class="a-center ">
					...
					<td class="actions">
						...
						<?php 
							echo $this->Html->link('<i class="fa fa-pencil"></i> Edit',
								array('controller' => 'users','action'=>'edit_driver', $user->id),
