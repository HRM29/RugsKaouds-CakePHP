						...
						<div class="col-xs-5">
							...
							<div class="controls">
								...
								<?php
										...
										echo $this->Form->control('image', ['type' => 'file', 'label' => false, 'required' => true, 'multiple' => true]);
									}
								} else {
									echo $this->Form->control('image', array("type" => "file", 'label' => false, 'required' => true, 'id' => 'carImage', 'multiple' => true));
								}
								?>
							</div>
						</div>
