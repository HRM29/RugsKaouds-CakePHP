	...
	<div class="row">
		<div class="col-xs-12">
			<div class="box box-primary">
				...
				<div class="box-body">
					<div class="col-sm-3">
						<label for="Fund">Label</label>
						<?= $this->Form->control('title', ['placeholder' => 'Project Label', 'label' => false, 'class' => 'form-control', 'value' => isset($savesearch['title']) ? $savesearch['title'] : '', 'required' => false]); ?>
					</div>
					<div class="col-sm-3">
					...
					<div class="col-sm-3">
						...
						<a href="<?= Router::url('/', true) . '/admin/Projects/clearSearch'; ?>" class="btn btn-primary clear">Clear</a>
					</div>
				</div><!-- /.box-body -->
							...
							<tr>
								...
								<td class="actions">
									...
									echo $this->Html->link(
										...
										array('controller' => 'Projects', 'action' => 'view', base64_encode($val->id)),
									...
									echo $this->Html->link(
										...
										array('controller' => 'Projects', 'action' => 'edit', base64_encode($val->id)),
									...
									echo $this->Html->link(
										...
										array('controller' => 'Projects', 'action' => 'delete', base64_encode($val->id)),
