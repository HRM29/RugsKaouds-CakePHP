			...
			<div class="box box-primary">
				...
				<div class="box-body">
					...
					<div class="form-group row">
						...
						<div class="col-xs-5">
							<label for="Name">No. of Redemptions</label>
							<?= $this->Form->control('redemption', ['placeholder' => 'No. of Redemptions', 'label' => false, 'type' => 'text', 'class' => 'form-control', "onkeypress" => "return NumericValidation(event)"]); ?>
						</div>
						<div class="col-xs-5">
						</div>
					</div>
