				...
				<div class="box-header with-border">
					...
					<div class="box-tools pull-right">
						<?php echo $this->Html->link('<i class="fa fa-pencil"></i> Edit',
							array('controller' => 'ShippingCharges','action'=>'edit',base64_encode($data->id)),
							array('escape' => false,'class'=>"btn btn-info btn-sm","title"=>__("Edit",true))
						);
						?>
						<?php  
							echo $this->Html->link('<i class="fa fa-trash"></i> Delete',
							array('controller' => 'ShippingCharges','action'=>'Delete',base64_encode($data->id)),
						...
						array('controller' => 'ShippingCharges','action'=>'index'),
