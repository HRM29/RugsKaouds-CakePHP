			...
			<div class="box box-primary">
				...
				<div class="box-body">
					...
					<div class="col-sm-3">
						...
						<a href="<?= Router::url('/', true).'/admin/ShippingCharges/clearSearch';?>" class="btn btn-primary clear">Clear</a>
					</div> 
                  </div><!-- /.box-body --> 
		...
		<div class="col-xs-12"> 
		  <div class="box">
			<div class="box-header">
			  ...
			  <div class="box-tools">
					<?php 
					echo $this->Html->link('<i class="fa fa-plus"></i> Add ShippingCharges',
					array('controller' => 'ShippingCharges','action'=>'add'),
					array('escape' => false,'class'=>"btn btn-success btn-sm","title"=>__("Add ShippingCharges",true))
					);
					?> 
					<?php 
			...
			<div class="box-body table-responsive no-padding">
				...
				<tr>
					...
					<th><?= $this->Paginator->sort('Charges') ?></th> 
		...
		if(favorite.length < 1){
			...
			if(confirm('Are you sure you want to delete the selected pages?')){
				if(favorite.length > 0){
					...
					var url 	= '<?php echo Router::url('/', true).'admin/ShippingCharges/deleteAllCharges';?>';
