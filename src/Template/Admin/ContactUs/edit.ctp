...
<section class="content-header">
  ...
  <ol class="breadcrumb">
	...
	<li class="active">Edit Currencys</li>
  </ol> 
</section>
		...
		<div class="col-md-12"> 
			<div class="box box-primary">
                <div class="box-header with-border">
					<h3 class="box-title">Edit Currencys</h3>
                </div><!-- /.box-header -->
                <?php // $this->Form->create($currencysEdit, ['type' => 'file','id'=>'currencysEditForm']) ?>
                <?php echo $this->Form->create($currencysEdit,['type'=>'post','enctype' => 'multipart/form-data']); ?>
				<div class="box-body">
