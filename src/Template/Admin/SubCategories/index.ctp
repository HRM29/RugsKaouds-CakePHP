		...
		<div class="col-xs-12">
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title">Search SubCategories</h3>
                </div>
				<?php echo $this->Form->create($subcategories,array(
				...
				?> 
                  <div class="box-body">
                    <div class="col-sm-3">
						...
						<?= $this->Form->control('title', ['placeholder'=>'First Name','label'=>false,'class'=>'form-control','value'=>isset($savesearch['title'])?$savesearch['title']:'','required' => false]);?>
                    </div>
                    <div class="col-sm-3">
		...
		<div class="col-xs-12"> 
		  <div class="box">
			<div class="box-header">
			  ...
			  <div class="box-tools">
					<?php 
					echo $this->Html->link('<i class="fa fa-plus"></i> Add SubCategory',
					array('controller' => 'SubCategories','action'=>'add'),
					array('escape' => false,'class'=>"btn btn-success btn-sm","title"=>__("Add SubCategory",true))
					);
					?>
                     
					<?php 
					echo $this->Html->link('<i class="fa fa-trash"></i> Delete All',
					array('controller' => 'SubCategories','action'=>'deleteAll'),
					array('escape' => false,'class'=>"btn btn-danger btn-sm btnDeleteAll","title"=>__("Delete Category",true))
					);
					?> 
			...
			<div class="box-body table-responsive no-padding">
			  ...
			  <table class="table table-hover"> 
				...
				<tr>
					...
					<td><?= $this->General->getCategory($category->parent_id) ?></td> 
					<td><?= $this->General->getStatus($category->status) ?></td>
					<td><?= h($category->created) ?></td> 
					<td class="actions">
						<?php 
							echo $this->Html->link('<i class="fa fa-eye"></i> View',
								array('controller' => 'SubCategories','action'=>'view',base64_encode($category->id)),
								array('escape' => false,'class'=>"btn btn-primary btn-sm","title"=>__("View",true)));
						?>
						<?php 
							echo $this->Html->link('<i class="fa fa-pencil"></i> Edit',
								array('controller' => 'SubCategories','action'=>'edit',base64_encode($category->id)),
								array('escape' => false,'class'=>"btn btn-info btn-sm","title"=>__("Edit",true)));
						?>
						<?php 
							echo $this->Html->link('<i class="fa fa-trash"></i> Delete',
								array('controller' => 'SubCategories','action'=>'delete',base64_encode($category->id)),
