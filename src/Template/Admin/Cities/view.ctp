				...
				<div class="box-header with-border">
					...
					<div class="box-tools pull-right">
						<?php echo $this->Html->link('<i class="fa fa-pencil"></i> Edit',
							array('controller' => 'cities','action'=>'edit',base64_encode($data->id)),
							array('escape' => false,'class'=>"btn btn-info btn-sm","title"=>__("Edit",true))
						);
						?>
						<?php  
						/*	echo $this->Html->link('<i class="fa fa-trash"></i> Delete',
							array('controller' => 'cities','action'=>'Delete',base64_encode($data->id)),
				...
				<div class="col-md-4">
					  <div class="box box-warning">
						...
						<div class="box-body" style="display: block;">
						  <?= $this->General->getCountry($data->con_id); ?>
						</div><!-- /.box-body -->
					  </div><!-- /.box -->
				</div>
				<div class="box-body table-responsive"> 
					<div class="col-md-4">
					  <div class="box box-success">
						...
						<div class="box-body" style="display: block;">
						  <?= $this->General->getStates($data->sta_id); ?>
						</div><!-- /.box-body -->
					  </div><!-- /.box -->
					</div>
