			...
			<div class="box box-primary">
				...
				<div class="box-body">
					...
					<div class="form-group">
						...
						<?= $this->Form->control('sta_id', ['options'=>$states,'label'=>false,'class'=>'form-control state','empty'=>'Select States']);?>
					</div>
					<div class="form-group">
						<label for="Title">City Name</label>
						<?= $this->Form->control('name', ['placeholder'=>'City Name','label'=>false,'class'=>'form-control']);?>
					</div>
