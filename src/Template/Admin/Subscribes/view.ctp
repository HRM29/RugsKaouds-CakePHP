				...
				<div class="box-header with-border">
					...
					<div class="box-tools pull-right">
						<?php echo $this->Html->link('<i class="fa fa-pencil"></i> Edit',
							array('controller' => 'SubCategories','action'=>'edit',base64_encode($subcategory->id)),
							array('escape' => false,'class'=>"btn btn-info btn-sm","title"=>__("Edit",true))
						);
						?>
						<?php  
							echo $this->Html->link('<i class="fa fa-trash"></i> Delete',
							array('controller' => 'SubCategories','action'=>'Delete',base64_encode($subcategory->id)),
							array('escape' => false,'confirm' => __('Are you sure you want to Delete?',$subcategory->id),
							'class'=>"btn btn-danger btn-sm","title"=>__("Delete",true))
							); 
						?>
						<?php 
				...
				<div class="box-body table-responsive"> 
					...
					<div class="col-md-4">
					  <div class="box box-warning">
						...
						<div class="box-body" style="display: block;">
						  <?= $this->General->getCategorys($subcategory->parent_id) ?>
						</div><!-- /.box-body -->
					  </div><!-- /.box -->
					</div>
					...
					<div class="col-md-4">
					  <div class="box box-danger">
						...
						<div class="box-body" style="display: block;">
						  <?= $this->General->getAdminStatus($subcategory->status); ?>
						</div><!-- /.box-body -->
					  </div><!-- /.box -->
					</div>
					...
					<div class="col-md-4">
					  <div class="box box-info">
						...
						<div class="box-body" style="display: block;">
						  <?= date("Y-m-d H:i A",strtotime($subcategory->created)); ?>
						</div><!-- /.box-body -->
					  </div><!-- /.box -->
					</div>
					...
					<div class="col-md-4">
					  <div class="box box-primary">
						...
						<div class="box-body" style="display: block;">
						  <?= date("Y-m-d H:i A",strtotime($subcategory->modified)); ?>
						</div><!-- /.box-body -->
					  </div><!-- /.box -->
					</div>
