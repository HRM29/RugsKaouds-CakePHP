					...
					<div class="col-md-12">
						<div class="box box-success">
							...
							<div class="box-body" style="display: block;">
								...
								<?php /* $data =  $this->General->getProductImages($result->id);
									 foreach($data as $images){
								?>
										<img src="<?php echo $images->image; ?>" alt='<?php echo $result->title; ?>'  style="height:80px;" />
								<?php } */ ?>	
								<?php 
									$img_src = 'https://shrugs.com/rug_pictures/';	
									
									$img_no = str_replace("ORC"," ",$result->sku_no );
									...
									for($j=1;$j<=12;$j++) 
									{
										...
										?>
											...
											<img src="<?php echo $fileUrl; ?>" alt='<?php echo $result->title; ?>'  style="height:80px;" /> 
									<?php  
									}}
									if($this->General->remote_file_exists($fileUrl) == "")
										{	$data =  $this->General->getProductImages($result->id);
									 foreach($data as $images){
									?>
										<img src="<?php echo $images->image; ?>" alt='<?php echo $result->title; ?>'  style="height:80px;" />
										<?php }}
