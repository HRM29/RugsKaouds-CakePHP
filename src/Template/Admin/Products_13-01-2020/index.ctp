				...
				<tr>
									...
									<td>
										...
										<?php 
											...
											$img_no = str_replace("GOR"," ",$product->sku_no );
											...
											<?php }else{
											?>
											<img src="<?php echo $this->General->getProductSingleImages($product->id)->image; ?>" alt="<?php echo $product->title; ?>" style="height:80px;" />
											<?php
											}?>
									</td>
									...
									<td class="actions">
										...
										<?php 
											echo $this->Html->link('<i class="fa fa-trash"></i> Delete',
												...
												array('escape' => false,'class'=>"btn btn-danger btn-sm","title"=>__("Delete",true),'confirm' => __('Are you sure you want to delete # {0}?', $product->id)));
										?> 
									</td> 
								</tr>
				<?php endforeach; ?> 
