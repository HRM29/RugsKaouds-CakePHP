				...
				<div class="box-body">
					...
					<div class="form-group row">
						...
						<div class="col-xs-2">
                            ...
                            <div class="controls">
								<?= $this->Form->control('age', ['placeholder'=> 'Age','label'=>false,'type'=>'text','class'=>'form-control','required'=>true]);?>
                            </div>
                        </div>
						<div class="col-xs-2">
					...
					<div class="form-group row">
						...
						<div class="col-xs-5">
							...
							<?= $this->Form->control('location', ['placeholder'=> 'Location','label'=>false,'class'=>'form-control']);?>
						</div>
						<div class="col-xs-5">
					...
					<div class="form-group row">
						<div class="col-xs-5">
                            <label for="normal" class="control-label">Image<span style="color:red;">*</span></label>
						  ...
						  <?php 
									...
									if(!empty($product->product_images)){
										foreach($product->product_images as $key=> $dataImg){
										      
										  $original = $dataImg->image;
											//if(file_exists($original) && !empty($dataImg->image)) {
							?>
												<li>					 
							<?php 
													echo $this->Html->image($dataImg->image, array('width' => '150px', 'class' => 'img-responsive imgbdr','heignt'=> '100'));
													echo $this->Html->link('Remove', 'javascript:void(0);', array('data' => $dataImg->id, 'id' => 'remove_image','class' => 'remove_image'));
