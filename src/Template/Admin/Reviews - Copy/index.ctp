				...
				?> 
                  <div class="box-body">
                    <div class="col-sm-3">
						...
						<?= $this->Form->control('user_id', ['empty'=>'Select Users','label'=>false,'class'=>'form-control','value'=>isset($savesearch['user_id'])?$savesearch['user_id']:'','required' => false,'options'=>$users]);?> 
                    </div> 
					...
					<div class="col-sm-3">
						...
						<a href="<?= Router::url('/', true).'/admin/UserLoginLogs/clearSearch';?>" class="btn btn-primary clear">Clear</a>
					</div> 
                  </div><!-- /.box-body --> 
			...
			<div class="box-body table-responsive no-padding">
			  ...
			  <table class="table table-hover"> 
				...
				<tr>
					...
					<td><?= h($this->General->getUsers($data->user_id)) ?></td>
					<td><?= h($data->way) ?></td>
					<td><?= h($data->ip) ?></td>
