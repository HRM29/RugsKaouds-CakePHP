		...
		<div class="col-xs-12">
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title">Search Colors</h3>
				</div>
				<?php echo $this->Form->create($result,array('class' =>'form-horizontal form-label-left', 'id'=>'demo-form2', 'inputDefaults' => array('label' => false, 'div' => false, 'novalidate' => true))); ?>
					<div class="box-body">
						<div class="col-sm-3">
							...
							<?= $this->Form->control('name', ['placeholder'=>'Color Name','label'=>false,'class'=>'form-control','value'=>isset($savesearch['name']) ? $savesearch['name'] : '','required' => false]); ?>
						</div>
						<div class="col-sm-3">
						...
						<div class="col-sm-3">
							...
							<a href="<?php echo Router::url('/', true).'/admin/colors/clearSearch';?>" class="btn btn-primary clear">Clear</a>
						</div> 
					</div><!-- /.box-body --> 
		...
		<div class="col-xs-12"> 
			<div class="box">
				<div class="box-header">
				  ...
				  <div class="box-tools">
						<?php 
							echo $this->Html->link('<i class="fa fa-plus"></i> Add Color', array('controller' => 'colors','action'=>'add'), array('escape' => false,'class'=>"btn btn-success btn-sm","title"=>__("Add Color",true)));
						?>
						<?php 
							echo $this->Html->link('<i class="fa fa-trash"></i> Delete All', 'javascript::void()', array('escape' => false,'class'=>"btn btn-danger btn-sm btnDeleteAll","title"=>__("Delete Color",true),'confirm' => 'Are you sure you want to delete the selected colors?'));
						?>
					</div>
				</div><!-- /.box-header -->
				<div class="box-body table-responsive no-padding">
					...
					<table class="table table-hover"> 
						<tr>
							...
							<th><?php echo $this->Paginator->sort('Color Name'); ?></th>
						...
						if(!empty($result)) {
							foreach($result as $record) { ?>
								<tr>
									...
									<td class="actions">
										<?php
											echo $this->Html->link('<i class="fa fa-eye"></i> View', array('controller' => 'colors','action'=>'view', $record->id), array('escape' => false,'class'=>"btn btn-primary btn-xs","title"=>__("View",true)));
										?>
										<?php 
