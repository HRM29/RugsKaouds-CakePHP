		...
		<div class="col-xs-12">
			<div class="box">
				<div class="box-header with-border">
					<h3 class="box-title">View Color</h3>
					<div class="box-tools">
						<?php 
				...
				<div class="box-body table-responsive">
					<div class="col-md-3">
						<div class="box box-success">
							...
							<div class="box-body" style="display: block;">
								<?php echo !empty($result->name) ? $result->name : ''; ?>
							</div>
							<!-- /.box-body -->
						</div>
						<!-- /.box -->
					...
					<div class="col-md-3">
						<div class="box box-primary">
							<div class="box-header with-border">
								<h3 class="box-title">Color Description</h3>
								<div class="box-tools pull-right">
									<button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
								</div>
								<!-- /.box-tools -->
					...
					<div class="col-md-3">
						<div class="box box-info">
							...
							<!-- /.box-header -->
							<div class="box-body" style="display: block;">
								<?php echo !empty($result->meta_title) ? ucfirst($result->meta_title) : ''; ?>
							</div>
							<!-- /.box-body -->
						</div>
						<!-- /.box -->
