			...
			<div class="box box-primary">
				...
				<div class="box-body">
					<div class="col-sm-3">
							...
							<?= $this->Form->control('title', ['placeholder'=>'Size','label'=>false,'class'=>'form-control','value'=>isset($savesearch['title'])?$savesearch['title']:'','required' => false]);?>
					</div> 
					<div class="col-sm-3">
					...
					<div class="col-sm-3">
						...
						<a href="<?= Router::url('/', true).'/admin/sizes/clearSearch';?>" class="btn btn-primary clear">Clear</a>
					</div> 
                  </div><!-- /.box-body --> 
		...
		<div class="col-xs-12"> 
		  <div class="box">
			<div class="box-header">
			  ...
			  <div class="box-tools">
					<?php 
					echo $this->Html->link('<i class="fa fa-plus"></i> Add Sizes',
					array('controller' => 'sizes','action'=>'add'),
					array('escape' => false,'class'=>"btn btn-success btn-sm","title"=>__("Add Sizes",true))
					);
					?> 
					<?php 
			...
			<div class="box-body table-responsive no-padding">
				<?php echo $this->Form->create('',['url'=>['action'=>'deleteAllColours'],'id'=>'listForm']); ?>
				<?php echo $this->Form->end()?>    
		...
		if(favorite.length < 1){
			...
			if(confirm('Are you sure you want to delete the selected pages?')){
				if(favorite.length > 0){
					...
					var url 	= '<?php echo Router::url('/', true).'admin/colours/deleteAllBrands';?>';
