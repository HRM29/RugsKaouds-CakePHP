			...
			<div class="box box-primary">
				...
				<div class="box-body">
					...
					<div class="form-group row">
						...
						<div class="col-xs-5">
							<label for="Password">Sold Status<span style="color:red;">*</span></label>
							...
							<ul>
								...
								if (!empty($product->product_images)) {
									...
									foreach ($product->product_images as $key => $dataImg) {
										...
										$filePath =  WWW_ROOT . 'uploads' . DS . 'product' . DS . $inFolder . DS . $original;

										$fileUrl = $img_src . $inFolder . "/" . $original;

										if (file_exists($filePath) && !empty($dataImg->image)) {
								?>
											<li>
												<?php
												echo $this->Html->image($fileUrl, array('width' => '150px', 'class' => 'img-responsive imgbdr', 'heignt' => '100'));
