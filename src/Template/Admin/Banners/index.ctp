	    ...
	    <div class="col-xs-12">
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title">Search Banners</h3>
                </div>
				...
				<div class="box-body">
					...
					<div class="col-sm-3">
						...
						<a href="<?= Router::url('/', true).'/admin/Banners/clearSearch';?>" class="btn btn-primary clear">Clear</a>
					</div> 
                  </div><!-- /.box-body --> 
		...
		<div class="col-xs-12"> 
		  <div class="box">
			<div class="box-header">
			  ...
			  <div class="box-tools">
					<?php 
					echo $this->Html->link('<i class="fa fa-plus"></i> Add Banners',
					array('controller' => 'Banners','action'=>'add'),
					array('escape' => false,'class'=>"btn btn-success btn-sm","title"=>__("Add Banners",true))
					);
					?> 
					<?php 
