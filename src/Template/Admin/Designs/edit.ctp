		...
		<div class="col-md-12"> 
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><?php echo __('Edit Design'); ?></h3>
					<div class="box-tools">
						<?php 
                ...
                <?php echo $this->Form->create($design, ['type' => 'file']); ?>
				<div class="box-body">
					<div class="form-group">
						<label for="name">Design Name<span class="required">*</span></label>
						<?php
							echo $this->Form->control('title', ['placeholder'=>'Design Name','label'=>false,'class'=>'form-control','required'=>true]);
						?>
					</div>
