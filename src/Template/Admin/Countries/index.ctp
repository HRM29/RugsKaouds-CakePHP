	...
	<div class="row">
	    <div class="col-xs-12">
			<div class="box box-primary">
				...
				<div class="box-body">
					<div class="col-sm-3">
							<label for="Fund">Country Name</label>
							<?= $this->Form->control('title', ['placeholder'=>'Country Name','label'=>false,'class'=>'form-control','value'=>isset($savesearch['title'])?$savesearch['title']:'','required' => false]);?>
					</div> 
					<div class="col-sm-3">
					...
					<div class="col-sm-3">
						...
						<a href="<?= Router::url('/', true).'/admin/Countries/clearSearch';?>" class="btn btn-primary clear">Clear</a>
					</div> 
                  </div><!-- /.box-body --> 
		...
		<div class="col-xs-12"> 
		  <div class="box">
			<div class="box-header">
			  ...
			  <div class="box-tools">
					<?php 
					echo $this->Html->link('<i class="fa fa-plus"></i> Add Country',
					array('controller' => 'Countries','action'=>'add'),
					array('escape' => false,'class'=>"btn btn-success btn-sm","title"=>__("Add Country",true))
					);
					?> 
					<?php 
		...
		if(favorite.length < 1){
			...
			if(confirm('Are you sure you want to delete the selected Country?')){
				if(favorite.length > 0){
					...
					var url 	= '<?php echo Router::url('/', true).'/admin/Countries/deleteAllCountry';?>';
