			...
			<div class="box box-primary">
				...
				<div class="box-body">
					...
					<div class="col-sm-3">
						...
						<a href="<?= Router::url('/', true).'/admin/currencies/clearSearch';?>" class="btn btn-primary clear">Clear</a>
					</div> 
                  </div><!-- /.box-body --> 
		...
		<div class="col-xs-12"> 
		  <div class="box">
			<div class="box-header">
			  ...
			  <div class="box-tools">
					<?php 
					echo $this->Html->link('<i class="fa fa-plus"></i> Add Currency',
					array('controller' => 'currencies','action'=>'add'),
					array('escape' => false,'class'=>"btn btn-success btn-sm","title"=>__("Add Currency",true))
					);
					?> 
					<?php 
			...
			<div class="box-body table-responsive no-padding">
				<?php echo $this->Form->create('',['url'=>['action'=>'deleteAllCurrency'],'id'=>'listForm']); ?>
				<?php echo $this->Form->end()?>    
				...
				<tr>
					...
					<th><?= $this->Paginator->sort('exchange_charge') ?></th>
