	    ...
	    <div class="col-xs-12">
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title">Search Order Status</h3>
                </div>
				...
				<div class="box-body">
					<div class="col-sm-3">
							<label for="Fund">Order status</label>
							<?= $this->Form->control('title', ['placeholder'=>'Order status','label'=>false,'class'=>'form-control','value'=>isset($savesearch['title'])?$savesearch['title']:'','required' => false]);?>
					</div> 
					<div class="col-sm-3">
		...
		<div class="col-xs-12"> 
		  <div class="box">
			<div class="box-header">
			  ...
			  <div class="box-tools">
					<?php 
					echo $this->Html->link('<i class="fa fa-plus"></i> Add Order Status',
					array('controller' => 'OrderStatus','action'=>'add'),
					array('escape' => false,'class'=>"btn btn-success btn-sm","title"=>__("Add Order Status",true))
					);
					?> 
					<?php 
