	...
	<div class="row">
		<div class="col-xs-12">
			<div class="box box-primary">
				...
				<?php echo $this->Form->create($users,array('class' =>'form-horizontal form-label-left', 'id'=>'demo-form2', 'inputDefaults' => array('label' => false, 'div' => false, 'novalidate' => true))); ?>
					<div class="box-body">
						<div class="col-sm-3">
						...
						<div class="col-sm-3">
							...
							<?php echo $this->Html->link('Clear',['action'=>'clearSearch'],['class'=>'btn btn-primary clear','title'=>'Clear Search']); ?>
						</div> 
					</div><!-- /.box-body -->
		...
		<div class="col-xs-12"> 
			<div class="box">
				<div class="box-header">
				  ...
				  <div class="box-tools">
						<?php 
							echo $this->Html->link('<i class="fa fa-plus"></i> Add User', array('controller' => 'users','action'=>'add'), array('escape' => false,'class'=>"btn btn-success btn-sm","title"=>__("Add User",true)));
						?>
						<?php 
							echo $this->Html->link('<i class="fa fa-trash"></i> Delete All', array('controller' => 'users','action'=>'deleteAllUsers'), array('escape' => false,'class'=>"btn btn-danger btn-sm btnDeleteAll","title"=>__("Delete User",true),'confirm' => 'Are you sure you want to delete the selected users?'));
						?>
						<?php
							echo $this->Html->link('<i class="fa fa-reply"></i> Back', array('controller' => 'users','action'=>'index'), array('escape' => false,'class'=>"btn btn-info btn-sm","title"=>__("Back",true)));
						?>
					</div>
				</div><!-- /.box-header -->
					...
					<table class="table table-hover"> 
						...
						if(!empty($users)) {
							...
							<tr>
								...
								<td><?= h($user->email) ?></td> 
								<td><?= $this->General->getAdminStatus($user->status) ?></td>
								...
								<td class="actions">
									...
									<?php 
										echo $this->Html->link('<i class="fa fa-trash"></i> Delete',
											...
											array('escape' => false,'class'=>"btn btn-danger btn-xs","title"=>__("Delete",true),'confirm' => __('Are you sure you want to delete # {0}?', $user->id)));
									?> 
								</td> 
							</tr>
							<?php
