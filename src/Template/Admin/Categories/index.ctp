				...
				?> 
                  <div class="box-body">
					...
					<div class="col-sm-3">
						...
						<a href="<?= Router::url('/', true).'/admin/categories/clearSearch';?>" class="btn btn-primary clear">Clear</a>
					</div> 
                  </div><!-- /.box-body --> 
		...
		<div class="col-xs-12"> 
		  <div class="box">
			<div class="box-header">
			  ...
			  <div class="box-tools">
					<?php 
					echo $this->Html->link('<i class="fa fa-plus"></i> Add Category',
					array('controller' => 'categories','action'=>'add'),
					array('escape' => false,'class'=>"btn btn-success btn-sm","title"=>__("Add Category",true))
					);
					?>
                     
					<?php 
					echo $this->Html->link('<i class="fa fa-trash"></i> Delete All',
					array('controller' => 'categories','action'=>'deleteAll'),
					...
					<td class="actions">
						...
						<?php 
							echo $this->Html->link('<i class="fa fa-trash"></i> Delete',
								...
								array('escape' => false,'class'=>"btn btn-danger btn-xs","title"=>__("Delete",true),'confirm' => __('Are you sure you want to delete ?', $category->id)));
						?> 
					</td> 
				</tr>
				<?php endforeach; ?> 
