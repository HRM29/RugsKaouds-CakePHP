												...
												<div class="product_info">
													...
													<div> 
														...
														<?php 
															...
															$inches = '';
															$s_val = '';
															if(!empty($products->dimension_1_feet && $products->dimension_2_feet)){
																$feet = $products->dimension_1_feet."'".$products->dimension_2_feet.'"';
															}
															
															
															
															if(!empty($products->dimension_1_inches && $products->dimension_2_inches)){
																$inches = $products->dimension_1_inches."'".$products->dimension_2_inches.'"';					
															}
															
															if(!empty($inches && $feet)){
																$s_val = ' X ';
															}
															
															$exact_Size = $feet.$s_val.$inches;
															echo $exact_Size; */
															
															echo $products->dimension_1_feet."'".$products->dimension_1_inches.'" x '.$products->dimension_2_feet."'".$products->dimension_2_inches.'"';
														?>
													</div>
													<div class="price">
														<strong>
