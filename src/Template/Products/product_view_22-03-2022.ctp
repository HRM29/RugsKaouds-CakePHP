  ...
  <div class="container">
    <div class="row">
			...
			<div class="row">
			  <div class="large-5 column">
				...
				<?php 
					...
					?>
						<img class="xzoom" id="xzoom-default" src="<?php echo $fileUr2l; ?>" xoriginal="<?php echo $fileUr2l; ?>" />
					 
					<?php }else{
					?>
						<img class="xzoom" id="xzoom-default" src="<?php echo Router::url('/', true);?>img/no-image.png" xoriginal="<?php echo Router::url('/', true);?>img/no-image.png" />
					<?php } ?>
					  ...
					  <?php 
						...
						if(!empty($imagesArr)) 
						{
							foreach($imagesArr as $imgs){
								...
								$filePath11 =  WWW_ROOT . 'uploads' . DS . 'product'.DS.$inFolder.DS. str_replace('jpg','JPG',$imgs->image);
						 
								$fileUrl11 = $img_src.$inFolder."/".str_replace('jpg','JPG',$imgs->image);
						...
						<?php  
								}else if(file_exists($filePath11)){
						?>	
									<a href="<?php echo $fileUrl11; ?>"><img class="xzoom-gallery" width="80" src="<?php echo $fileUrl11; ?>" alt="<?php echo $productDetail->title; ?>" class="img-fluid img-center"></a>
      ...
      <div class="col-md-6 col-sm-12 offset-md-1">
          ...
          <!--p class="label"><?= strtoupper($productDetail->title);  ?></p-->          <h1><?= strtoupper($productDetail->title);  ?><h1>
          <span class="product-prize">$<?= number_format($productDetail->selling_price,2);?></span>
  	...
  	<div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
		<div class="tt-add-info">
			<ul>
				...
				<li class="sku-js">
					<span>Origin:</span>
					<span><?= ucfirst(strtolower($productDetail->overstock_origin)); ?></span>
				</li>
