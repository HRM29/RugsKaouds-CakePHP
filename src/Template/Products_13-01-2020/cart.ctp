                           ...
                           <div class="card-header" id="headingTwo">
												...
												<table class="data-table" id="checkout-review-table">
													...
													$sub_total += round($item['selling_price'],2);
														...
														<tr>
															...
															<td><span class="cart-price"><span class="price"><?="$".round($item['selling_price'],2);?></span></span></td>
							 ...
							 <div class="card-body">
                              <div class="message alert alert-danger" style="display:none;"></div>
                                    <div class="row">
									   ...
									   <div class="col-sm-6">
                                          <div class="form-group">
											 ...
											 <?php echo $this->Form->input('creditcard_number', array('label' => false, 'class' => 'form-control ccinput','maxLength' => 20)); ?>
                                          </div>
                                       </div>
                                       <div class="col-sm-6">
                                          <div class="form-group">
											 ...
											 $options = array(
												...
												?>
											<?= $this->Form->control('creditcard_month', ['options'=>$options,'label'=>false,'class'=>'form-control']); ?>
                                          </div>
                                       </div>
									   <div class="col-sm-6">
                                          <div class="form-group">
											 ...
											 $options = array(
												   ...
												   ?>
												   <?= $this->Form->control('creditcard_year', ['options'=>$options,'label'=>false,'class'=>'form-control']); ?>
                                          </div>
                                       </div>
									   <div class="col-sm-6">
                                          <div class="form-group">
											 <label for="Password">Security Code</label>
											 <?php echo $this->Form->input('creditcard_code', array('label' => false, 'class' => 'form-control','maxLength' => 4)); ?>
                                          </div>
                                       </div>
									   <!--div class="form-group" id="credit_cards">
											<img src="<?php echo Router::url('/', true)."img/visa.jpg"; ?>" id="visa">
											<img src="<?php echo Router::url('/', true)."img/mastercard.jpg"; ?>" id="mastercard">
										</div-->
                                    ...
                                    <div class="order-btn"><button type="submit" class="view-button" id="continue_to_card">Place Order</button></div>
                              </div>
                           </div>
                        </div>
						<div id="divLoading"> 
                  ...
                  <div class="card cart-right">
					 ...
					 <?php
                        ...
                        <span class="badge badge-success">&nbsp;</span>
                           ...
                           <p class="offer-price mb-0">$<?= round($data['selling_price'],2);?>  <span class="regular-price">$<?= round($data['everyday_price'],2);?></span></p>
                        </div>
					 <?php }}else{ ?>
